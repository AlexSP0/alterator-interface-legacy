...
install -v -p -m 644 -D 48-alterator-interface-legacy.rules %buildroot%{_sysconfdir}/polkit-1/rules.d
...
%{_sysconfdir}/polkit-1/rules.d/48-alterator-interface-legacy.rules
